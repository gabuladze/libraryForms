...
SELECT id, first_name, last_name, email, password, role FROM users WHERE (id = @id)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[1].CommandText = "SELECT id, first_name, last_name, email, password, role FROM dbo.users";
        ...
        public virtual int FillBy(librarydbDataSet.usersDataTable dataTable) {
